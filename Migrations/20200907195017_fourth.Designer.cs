...
namespace ElAhram.Migrations
{
    ...
    [Migration("20200907195017_fourth")]
            ...
            modelBuilder.Entity("ElAhram.Models.امرتشغيل", b =>
                {
                    ...
                    b.HasIndex("كودالخامة", "نوع_فاتورة");
            ...
            modelBuilder.Entity("ElAhram.Models.بنود_الفاتورة", b =>
                {
                    ...
                    b.HasIndex("كودالمنتج", "نوع_فاتورة");
            ...
            modelBuilder.Entity("ElAhram.Models.امرتشغيل", b =>
                {
                    ...
                    b.HasOne("ElAhram.Models.المنتجات", "منتج")
                        .WithMany()
                        .HasForeignKey("كودالخامة", "نوع_فاتورة")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ElAhram.Models.بنود_الفاتورة", b =>
                {
                    ...
                    b.HasOne("ElAhram.Models.المنتجات", "منتج")
                        .WithMany()
                        .HasForeignKey("كودالمنتج", "نوع_فاتورة")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
