...
namespace CustomDocumentPaginator
{
    public class CustomDataGridDocumentPaginator : DocumentPaginator
    {
            ...
            if (itemsSource != null)
            {
                ...
                for (int index = startPos; index < endPos && index < itemsSource.Count; index++)
                {
                    ...
                    if (rowIndex > 0)
                    {
                       ...
                       //     brdr.Padding = new Thickness(5, 5, 5, 5);
                            tableGrid.Children.Add(alernatingRowBorder);
                           // tableGrid.Children.Add(brdr);
                        }
                    }
                ...
                image.Source = new BitmapImage(
                    new Uri(
                       "pack://application:,,,/pic/Alahramlogo.png"));
                myBrush.ImageSource = image.Source;

                myBrush.Stretch = Stretch.Fill;
                myBrush.Opacity = 0.1;
                tableGrid.Background = myBrush;
        ...
        private DocumentPage ConstructPage(Grid content, int pageNumber)
        {
            ...
            brdr.SetValue(Grid.RowProperty, 1);
            brdr.Padding = new Thickness(10, 20, 10, 20);
            ...
            //Content row
            AddGridRow(pageGrid, new GridLength(1.0d, GridUnitType.Star)); //new GridLength(Auto, GridUnitType.Star)
           ...
           // Canvas.SetBottom(pageGrid1, 1);
            ...
            if (content != null)
            {
               ...
               // content.Children.Add(pagedeatials);
                pageGrid.Children.Add(content);
            }
          //  pageGrid.Children.Add(brdr);

            Grid pagedeatials = new Grid();
            ...
            pageGrid.Children.Add(pagedeatials);
        ...
        private object CreateDocumentHeader()
        {
            ...
            Grid headerBorder = new Grid();
            headerBorder.Margin = new Thickness(0, 0, 0, 20);
            TextBlock titleText = new TextBlock();
            
            titleText.Style = this.DocumentHeaderTextStyle;
            titleText.TextTrimming = TextTrimming.CharacterEllipsis;
             titleText.Text = this.DocumentTitle;
            //titleText.Text = "كشف حساب";
            titleText.HorizontalAlignment = HorizontalAlignment.Center;
            headerBorder.Children.Add( titleText);
           ...
           // dateTimeText.HorizontalAlignment = HorizontalAlignment.Left;
            ...
            Uri x = new Uri("pack://application:,,,/pic/AlahramPl.png");

            System.Windows.Media.ImageSource bitmapImage = new BitmapImage(x);
            Image image = new Image()
            {
                Source = bitmapImage
            };
            ...
            headerBorder.Children.Add(image);
        ...
        private object CreateDocumentFooter(int pageNumber)
        {
            ...
            footerGrid.Margin = new Thickness(0, 20, 0, 0);
        ...
        private void AddTableColumn(Grid grid, double totalColumnWidth, int columnIndex, DataGridColumn column)
        {
            ...
            Border borx = new Border()
            {
                ...
                BorderBrush = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFF58322"))



            };
            borx.Padding = new Thickness(5, 5, 5, 15);
